...
export const NO_SERVICIO_OPTION_LABEL = "Ningun servicio (solo recurso)";
export const CAPACIDAD_SOLICITADA_LABEL = "Capacidad solicitada";
...
export const CAPACIDAD_SOLICITADA_PLACEHOLDER = "Ej: 4";
...
export const EMPTY_CAPACIDAD_SOLICITADA_ERROR = "Debes indicar la capacidad solicitada para reservar solo recurso";
...
export const INVALID_CAPACIDAD_SOLICITADA_ERROR = "La capacidad solicitada debe ser un número entero mayor que 0";
...
export const EMPTY_RECURSOS_CAPACIDAD_MESSAGE = "No hay recursos con capacidad suficiente";
