...
export const SEARCH_PLACEHOLDER = "Buscar plantilla por nombre";
export const NO_RESULTS_MESSAGE = "No hay plantillas que coincidan con tu busqueda";
export const NO_RESULTS_DESCRIPTION = "Prueba con otro termino o limpia el buscador.";
