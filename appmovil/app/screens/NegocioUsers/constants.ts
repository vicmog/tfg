...
export const negocioDeleteUserByIdRoute = (idNegocio: number) => API_ROUTES.deleteNegocioUserById(idNegocio);
...
export const DEFAULT_DELETE_ACCESS_ERROR = "No se pudo eliminar el acceso";
