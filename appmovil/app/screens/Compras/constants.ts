...
export const DELETE_SUCCESS_MESSAGE = "Compra eliminada correctamente";
export const DEFAULT_DELETE_ERROR = "No se pudo eliminar la compra";
export const DELETE_CONFIRM_TITLE = "Eliminar compra";
...
export const COMPLETE_BUTTON_TEXT = "Marcar como completada";
export const COMPLETE_SUCCESS_MESSAGE = "Compra completada correctamente";
export const DEFAULT_COMPLETE_ERROR = "No se pudo completar la compra";
