...
import { SAVE_ERROR_MESSAGE, SAVE_SUCCESS_MESSAGE, userByIdRoute } from "./constants";
import { PersonalDataEditProps } from "./types";
  ...
  useEffect(() => {
    const loadUserData = async () => {
      try {
        ...
        const route = userByIdRoute(id_usuario ?? "");
